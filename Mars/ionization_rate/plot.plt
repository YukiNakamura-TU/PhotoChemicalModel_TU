...
plot "./output/density/num/e-.dat"    u 2:1 w l lw 3 title "e^-", \
     ...
     "./output/density/num/O+.dat"    u 2:1 w l lw 3 title "O^+", \
     "./output/density/num/HCO+.dat"  u 2:1 w l lw 3 title "HCO^+", \
     ...
     "./output/density/num/N2H+.dat"  u 2:1 w l lw 3 title "N_2H^+", \
