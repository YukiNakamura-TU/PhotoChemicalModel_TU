...
program e__conductivity
  ...
  do iB = 0, 2*NB
    ...
    fname = trim(ADJUSTL(set%dir_name))//'/output/conductivity/B_Jupiter_i='//trim(ADJUSTL(char))//'/hi_sigma_HP0.dat'
    open(11, file = fname, status = 'unknown' )
      do iy = 1, grd%ny
      do ix = 1, grd%nx
    ...
    fname = trim(ADJUSTL(set%dir_name))//'/output/conductivity/B_Jupiter_i='//trim(ADJUSTL(char))//'/hi_sigma_HP0_ij.dat'
    open(11, file = fname, status = 'unknown' )
      do iy = 1, grd%ny
      do ix = 1, grd%nx
    ...
    fname = trim(ADJUSTL(set%dir_name))//'/output/conductivity/B_Jupiter_i='//trim(ADJUSTL(char))//'/hi_sigma_t-p.dat'
    open(11, file = fname, status = 'unknown' )
      do iy = 1, grd%ny
      do ix = 1, grd%nx
